...
extension UIApplication {
    ...
    public class func topViewController(_ base: UIViewController? = (UIApplication.value(forKeyPath: #keyPath(UIApplication.shared)) as! UIApplication).keyWindow?.rootViewController) -> UIViewController? {
